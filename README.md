...
## Day 5: Cafeteria
```
$ cargo bench --bench cafeteria_bench
    Finished `bench` profile [optimized] target(s) in 0.02s
     Running benches/cafeteria_bench.rs (target/release/deps/cafeteria_bench-8fa6ae1ec3b60272)

Cafeteria (Part 1)      time:   [102.87 µs 103.72 µs 104.74 µs]
                        change: [−3.2058% −1.1082% +0.8828%] (p = 0.29 > 0.05)
                        No change in performance detected.

Cafeteria (Part 2)      time:   [8.4427 µs 8.4514 µs 8.4606 µs]
                        change: [−3.5112% −1.7692% −0.4516%] (p = 0.01 < 0.05)
                        Change within noise threshold.
```
...
Trash Compactor (Part 2)
                        time:   [18.043 µs 18.070 µs 18.097 µs]
                        change: [−39.487% −39.355% −39.230%] (p = 0.00 < 0.05)
                        Performance has improved.
```
